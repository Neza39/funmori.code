(function () {
    let f = new FontFace("Unbounded", "url(https://fonts.gstatic.com/s/unbounded/v12/Yq6F-LOTXCb04q32xlpat-6uR42XTqtG6xjx44fNgc6L.woff2)");
    ...
    f.load().then(() => {
        ...
        function draw() {
            ...
            ctx.fillStyle = palette.text;
            ctx.textAlign = "left";
            ctx.font = "bold 26px Unbounded";
            ctx.fillText("Funmory – Learn and grow", 44, 52);

            ctx.font = "18px Unbounded";
